...
automatic_pix_instance = AutomaticPix.from_json(json)
# print the JSON string representation of the object
print(AutomaticPix.to_json())

# convert the object into a dict
automatic_pix_dict = automatic_pix_instance.to_dict()
# create an instance of AutomaticPix from a dict
automatic_pix_from_dict = AutomaticPix.from_dict(automatic_pix_dict)
```
