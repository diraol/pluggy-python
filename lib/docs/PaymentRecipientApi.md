# openapi_client.PaymentRecipientApi
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.PaymentRecipientApi(api_client)
    create_payment_recipient = openapi_client.CreatePaymentRecipient() # CreatePaymentRecipient | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    update_payment_recipient = openapi_client.UpdatePaymentRecipient() # UpdatePaymentRecipient | 
