...
**recipient** | [**PaymentRequestRecipient**](PaymentRequestRecipient.md) | Recipient of the payment. Shape depends on the recipient &#x60;type&#x60;. | [optional] 
**customer** | [**PaymentCustomer**](PaymentCustomer.md) | Customer associated with the payment request | [optional] 
**smart_account** | [**SmartAccount**](SmartAccount.md) | Smart account that receives the funds, when applicable | [optional] 
...
**automatic_pix** | [**AutomaticPix**](AutomaticPix.md) |  | [optional] 
