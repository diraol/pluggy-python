...
with pluggy_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = pluggy_sdk.SmartTransferApi(api_client)
    id = UUID('d0e8a7f0-6d86-11ea-b77f-2e728ce88125') # UUID | Payment primary identifier
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **UUID**| Payment primary identifier | 
...
# **smart_transfer_preauthorization_payments_list**
> SmartTransferPreauthorizationPaymentsList200Response smart_transfer_preauthorization_payments_list(id, var_from=var_from, to=to, page_size=page_size, page=page)
...
with pluggy_sdk.ApiClient(configuration) as api_client:
    ...
    var_from = '2024-01-01' # date | Filter payments created from this date (optional)
    to = '2024-12-31' # date | Filter payments created until this date (optional)
    page_size = 50 # float | Page size for the paging request, default: 500 (optional)
    page = 1 # float | Page number for the paging request, default: 1 (optional)

    try:
        # List preauthorization payments
        api_response = api_instance.smart_transfer_preauthorization_payments_list(id, var_from=var_from, to=to, page_size=page_size, page=page)
        print("The response of SmartTransferApi->smart_transfer_preauthorization_payments_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SmartTransferApi->smart_transfer_preauthorization_payments_list: %s\n" % e)
```
 ...
 **var_from** | **date**| Filter payments created from this date | [optional] 
 **to** | **date**| Filter payments created until this date | [optional] 
 **page_size** | **float**| Page size for the paging request, default: 500 | [optional] 
 **page** | **float**| Page number for the paging request, default: 1 | [optional] 

### Return type

[**SmartTransferPreauthorizationPaymentsList200Response**](SmartTransferPreauthorizationPaymentsList200Response.md)
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | Retrieve a list of all payments for the preauthorization |  -  |
