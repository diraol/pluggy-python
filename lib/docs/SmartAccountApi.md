# openapi_client.SmartAccountApi
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.SmartAccountApi(api_client)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.SmartAccountApi(api_client)
    create_smart_account_request = openapi_client.CreateSmartAccountRequest() # CreateSmartAccountRequest | 
