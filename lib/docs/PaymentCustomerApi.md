# openapi_client.PaymentCustomerApi
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.PaymentCustomerApi(api_client)
    create_payment_customer_request_body = openapi_client.CreatePaymentCustomerRequestBody() # CreatePaymentCustomerRequestBody | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    create_or_update_payment_customer = openapi_client.CreateOrUpdatePaymentCustomer() # CreateOrUpdatePaymentCustomer | 
