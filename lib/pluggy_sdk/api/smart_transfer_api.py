...
class SmartTransferApi:
    ...
    @validate_call
    def smart_transfer_preauthorization_payments_list(
        self,
        id: Annotated[UUID, Field(description="Preauthorization primary identifier")],
        var_from: Annotated[Optional[date], Field(description="Filter payments created from this date")] = None,
        to: Annotated[Optional[date], Field(description="Filter payments created until this date")] = None,
        page_size: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Page size for the paging request, default: 500")] = None,
        page: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Page number for the paging request, default: 1")] = None,
        _request_timeout: Union[
            None,
        ...
        :type id: UUID
        :param var_from: Filter payments created from this date
        :type var_from: date
        :param to: Filter payments created until this date
        :type to: date
        :param page_size: Page size for the paging request, default: 500
        :type page_size: float
        :param page: Page number for the paging request, default: 1
        ...
        _param = self._smart_transfer_preauthorization_payments_list_serialize(
            id=id,
            var_from=var_from,
            to=to,
            page_size=page_size,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SmartTransferPreauthorizationPaymentsList200Response",
            '404': "GlobalErrorResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def smart_transfer_preauthorization_payments_list_with_http_info(
        self,
        id: Annotated[UUID, Field(description="Preauthorization primary identifier")],
        var_from: Annotated[Optional[date], Field(description="Filter payments created from this date")] = None,
        to: Annotated[Optional[date], Field(description="Filter payments created until this date")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SmartTransferPreauthorizationPaymentsList200Response]:
        """List preauthorization payments
    ...
    @validate_call
    def smart_transfer_preauthorization_payments_list_without_preload_content(
        self,
        id: Annotated[UUID, Field(description="Preauthorization primary identifier")],
        var_from: Annotated[Optional[date], Field(description="Filter payments created from this date")] = None,
        to: Annotated[Optional[date], Field(description="Filter payments created until this date")] = None,
    ...
    def _smart_transfer_preauthorization_payments_list_serialize(
        self,
        id,
        var_from,
        to,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/smart-transfers/preauthorizations/{id}/payments',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
