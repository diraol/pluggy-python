...
class AcquirerReceivableApi:
    ...
    @validate_call
    def acquirer_receivable_retrieve(
        self,
        id: Annotated[StrictStr, Field(description="Acquirer receivable primary identifier")],
        ...
        _param = self._acquirer_receivable_retrieve_serialize(
            id=id,
    ...
    @validate_call
    def acquirer_receivable_retrieve_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Acquirer receivable primary identifier")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AcquirerReceivable]:
        """Retrieve
    ...
    @validate_call
    def acquirer_receivable_retrieve_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Acquirer receivable primary identifier")],
        _request_timeout: Union[
            None,
    ...
    def _acquirer_receivable_retrieve_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def acquirer_receivables_list_without_preload_content(
        self,
        item_id: Annotated[StrictStr, Field(description="Item primary identifier")],
        var_from: Annotated[Optional[datetime], Field(description="Filter greater than date. Format (yyyy-mm-dd)")] = None,
        to: Annotated[Optional[datetime], Field(description="Filter lower than date. Format (yyyy-mm-dd)")] = None,
    ...
    def _acquirer_receivables_list_serialize(
        self,
        item_id,
        var_from,
        to,
