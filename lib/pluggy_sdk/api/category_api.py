...
class CategoryApi:
    ...
    @validate_call
    def client_category_rules_delete(
        self,
        id: Annotated[UUID, Field(description="Category rule primary identifier")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: Category rule primary identifier (required)
        :type id: UUID
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._client_category_rules_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def client_category_rules_delete_with_http_info(
        self,
        id: Annotated[UUID, Field(description="Category rule primary identifier")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def client_category_rules_delete_without_preload_content(
        self,
        id: Annotated[UUID, Field(description="Category rule primary identifier")],
        _request_timeout: Union[
            None,
    ...
    def _client_category_rules_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/categories/rules/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
