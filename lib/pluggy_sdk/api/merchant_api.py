...
class MerchantApi:
    ...
    @validate_call
    def merchants_get_by_cnpj(
        self,
        cnpjs: Annotated[Optional[StrictStr], Field(description="Comma-separated list of CNPJs")] = None,
        ...
        :param cnpjs: Comma-separated list of CNPJs
        :type cnpjs: str
        ...
        _param = self._merchants_get_by_cnpj_serialize(
            cnpjs=cnpjs,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "MerchantsGetByCnpj200Response",
        }
    ...
    @validate_call
    def merchants_get_by_cnpj_with_http_info(
        self,
        cnpjs: Annotated[Optional[StrictStr], Field(description="Comma-separated list of CNPJs")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MerchantsGetByCnpj200Response]:
        """Get merchants by CNPJ list
    ...
    @validate_call
    def merchants_get_by_cnpj_without_preload_content(
        self,
        cnpjs: Annotated[Optional[StrictStr], Field(description="Comma-separated list of CNPJs")] = None,
        _request_timeout: Union[
            None,
    ...
    def _merchants_get_by_cnpj_serialize(
        self,
        cnpjs,
        _request_auth,
        _content_type,
        ...
        if cnpjs is not None:
            ...
            _query_params.append(('cnpjs', cnpjs))
