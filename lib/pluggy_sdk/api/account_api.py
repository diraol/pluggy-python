...
class AccountApi:
    ...
    def account_balance_get(
        ...
        _param = self._account_balance_get_serialize(
            id=id,
    ...
    @validate_call
    def account_balance_get_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Account primary identifier")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AccountBalanceGet200Response]:
        """Get real-time balance
    ...
    @validate_call
    def account_balance_get_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Account primary identifier")],
        _request_timeout: Union[
            None,
    ...
    def _account_balance_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/accounts/{id}/balance',
    ...
    def account_statements_list(
        ...
        _param = self._account_statements_list_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AccountStatementsList200Response",
            '400': "GlobalErrorResponse",
            '500': "GlobalErrorResponse",
        }
        response_data = self.api_client.call_api(
    ...
    @validate_call
    def account_statements_list_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Account primary identifier")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AccountStatementsList200Response]:
        """List account statements
    ...
    @validate_call
    def account_statements_list_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Account primary identifier")],
        _request_timeout: Union[
            None,
    ...
    def _account_statements_list_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/accounts/{id}/statements',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
