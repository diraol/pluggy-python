...
class PageResponseAcquirerSales(BaseModel):
    """
    
    """ # noqa: E501
    results: List[AcquirerSale]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [AcquirerSale.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
            "page": obj.get("page"),
            "total": obj.get("total"),
