...
class PaymentRequest(BaseModel):
    ...
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['CREATED', 'CANCELED', 'SCHEDULED', 'EXPIRED', 'AUTHORIZED', 'IN_PROGRESS', 'ERROR', 'COMPLETED', 'WAITING_PAYER_AUTHORIZATION']):
            raise ValueError("must be one of enum values ('CREATED', 'CANCELED', 'SCHEDULED', 'EXPIRED', 'AUTHORIZED', 'IN_PROGRESS', 'ERROR', 'COMPLETED', 'WAITING_PAYER_AUTHORIZATION')")
        return value
