...
class PaymentRequest(BaseModel):
    ...
    recipient: Optional[PaymentRequestRecipient] = Field(default=None, description="Recipient of the payment. Shape depends on the recipient `type`.")
    customer: Optional[PaymentCustomer] = Field(default=None, description="Customer associated with the payment request")
    smart_account: Optional[SmartAccount] = Field(default=None, description="Smart account that receives the funds, when applicable", alias="smartAccount")
    ...
    automatic_pix: Optional[AutomaticPix] = Field(default=None, alias="automaticPix")
    ...
    __properties: ClassVar[List[str]] = ["id", "amount", "fees", "description", "status", "clientPaymentId", "createdAt", "updatedAt", "callbackUrls", "recipient", "customer", "smartAccount", "paymentUrl", "pixQrCode", "boleto", "automaticPix", "schedule", "errorDetail", "isSandbox"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recipient": PaymentRequestRecipient.from_dict(obj["recipient"]) if obj.get("recipient") is not None else None,
            ...
            "automaticPix": AutomaticPix.from_dict(obj["automaticPix"]) if obj.get("automaticPix") is not None else None,
