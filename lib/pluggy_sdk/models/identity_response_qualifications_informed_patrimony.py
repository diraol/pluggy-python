...
class IdentityResponseQualificationsInformedPatrimony(BaseModel):
    ...
    var_date: Optional[datetime] = Field(default=None, description="Reference date of the patrimony. Returned on the business path of Open Finance, where the source field is a full date rather than just a year", alias="date")
    __properties: ClassVar[List[str]] = ["amount", "year", "date"]
