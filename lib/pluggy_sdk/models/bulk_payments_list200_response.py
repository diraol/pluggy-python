...
class BulkPaymentsList200Response(BaseModel):
    """
    ...
    results: Optional[List[BulkPayment]] = Field(default=None, description="List of bulk payments")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [BulkPayment.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
