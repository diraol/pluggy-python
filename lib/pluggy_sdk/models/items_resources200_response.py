...
class ItemsResources200Response(BaseModel):
    """
    ...
    results: Optional[List[ItemResource]] = Field(default=None, description="List of declared resources")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [ItemResource.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
