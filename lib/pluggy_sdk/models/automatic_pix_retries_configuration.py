...
class AutomaticPixRetriesConfiguration(BaseModel):
    """
    ...
    """ # noqa: E501
    retry_days: List[StrictInt] = Field(alias="retryDays")
    __properties: ClassVar[List[str]] = ["retryDays"]

    @field_validator('retry_days')
    def retry_days_validate_enum(cls, value):
        """Validates the enum"""
        for i in value:
