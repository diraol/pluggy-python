...
class SmartTransferPreauthorizationPaymentsList200Response(BaseModel):
    """
    ...
    results: Optional[List[SmartTransferPayment]] = Field(default=None, description="List of payments")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [SmartTransferPayment.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
