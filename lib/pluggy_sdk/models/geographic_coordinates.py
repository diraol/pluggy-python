...
class GeographicCoordinates(BaseModel):
    ...
    """ # noqa: E501
    latitude: Union[StrictFloat, StrictInt] = Field(description="Latitude. Between -90 and 90 (e.g. -23.5475)")
    longitude: Union[StrictFloat, StrictInt] = Field(description="Longitude. Between -180 and 180 (e.g. -46.6361)")
