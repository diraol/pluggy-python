...
class AggregatedPortfolioResponse(BaseModel):
    """
    ...
    results: Optional[List[AggregatedPortfolio]] = Field(default=None, description="Snapshot of assets-portfolio by period indicated")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [AggregatedPortfolio.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
