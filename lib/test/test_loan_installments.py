    ...
    def make_instance(self, include_optional) -> LoanInstallments:
        ...
        if include_optional:
            return LoanInstallments(
                ...
                balloon_payments = [
                    openapi_client.models.loan_installment_balloon_payment.LoanInstallmentBalloonPayment(
                        due_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        amount = openapi_client.models.loan_installment_balloon_payment_amount.LoanInstallmentBalloonPaymentAmount(
                            value = 1.337, 
                            currency_code = 'BRL', ), )
                    ]
            )
