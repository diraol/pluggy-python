    ...
    def make_instance(self, include_optional) -> Loan:
        ...
        if include_optional:
            return Loan(
                ...
                cnpj_consignee = '',
                interest_rates = [
                    openapi_client.models.loan_interest_rate.LoanInterestRate(
                        tax_type = 'NOMINAL', 
                ...
                contracted_fees = [
                    openapi_client.models.loan_contracted_fee.LoanContractedFee(
                        name = '', 
                        code = '', 
                        charge_type = 'UNIQUE', 
                        charge = 'MINIMUM', 
                ...
                contracted_finance_charges = [
                    openapi_client.models.loan_contracted_finance_charge.LoanContractedFinanceCharge(
                        type = '', 
                        additional_info = '', 
                        rate = 1.337, )
                    ],
                warranties = [
                    openapi_client.models.loan_warranty.LoanWarranty(
                        currency_code = 'BRL', 
                        type = '', 
                        subtype = '', 
                        amount = 1.337, )
                ...
                payments = openapi_client.models.loan_payments.LoanPayments(
